    ...
    <div class="main-container">
        <div class="page-header">
            ...
            <p class="page-subtitle">
                Export des Bulletins de Vente pour le café
            </p>
        </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control">
                            ...
                            <option value="ARABICA">ARABICA EXPORT</option>
                            <option value="PRESTIGE">CAFÉ PRESTIGE</option>
                            <option value="QUALITE">CAFÉ QUALITÉ SUP</option>
                        </select>
                    </div>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>12</td>
                            <td>
                                <span class="class-badge">Classe 1</span>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>28</td>
                            <td>
                                <span class="class-badge">Classe 2</span>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="grade-badge">
                                    <i class="fas fa-star"></i> Grade AAA
                                </span>
                            </td>
                            <td>06/10/2024</td>
                            <td>03/10/2024</td>
                        ...
                        <tr>
                            ...
                            <td>35</td>
                            <td>
                                <span class="class-badge">Classe 3</span>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>REF-CAF-2024-005</td>
                            <td>CAFÉ QUALITÉ SUP</td>
                            <td>Magasin Ouest</td>
                            <td>LOT-CAF-005</td>
                            <td>190</td>
                            <td>2024/2025</td>

<?php 
$pageTitle = "Validation Résultats Cacao";
    ...
    <style>
        * {
        ...
        .data-table {
            ...
            font-size: 0.75rem;
            min-width: 1800px; /* Largeur minimale pour forcer le défilement */
        }
...
<body>
    <div class="main-container">
        <div class="page-header">
            ...
            <p class="page-subtitle">
                Validation des analyses de qualité du cacao
            </p>
        </div>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Analyseur A</td>
                            <td>2024/2025</td>
                            <td><input type="text" class="table-input" value="2.5"></td>
                            <td><input type="text" class="table-input" value="1.2"></td>
                            <td><input type="text" class="table-input" value="0.8"></td>
                            <td><input type="text" class="table-input" value="0.3"></td>
                            <td><input type="text" class="table-input" value="85"></td>
                            <td><input type="text" class="table-input" value="7.2"></td>
                            <td><input type="text" class="table-input" value="1.5"></td>
                            <td><input type="text" class="table-input" value="0.8"></td>
                            <td><input type="text" class="table-input" value="2.1"></td>
                            <td><input type="text" class="table-input" value="1.2"></td>
                            <td><input type="text" class="table-input" value="0.5"></td>
                            <td><input type="text" class="table-input" value="0.9"></td>
                            <td><input type="text" class="table-input" value="3.2"></td>
                            <td>
                            ...
                            <td><input type="text" class="table-input" placeholder="Remarque..."></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="table-input" value="1.5"></td>
                            <td><input type="text" class="table-input" value="0.9"></td>
                            <td><input type="text" class="table-input" value="78"></td>
                            <td><input type="text" class="table-input" value="8.1"></td>
                            <td><input type="text" class="table-input" value="2.8"></td>
                            <td><input type="text" class="table-input" value="1.9"></td>
                            <td><input type="text" class="table-input" value="3.5"></td>
                            <td><input type="text" class="table-input" value="2.2"></td>
                            <td><input type="text" class="table-input" value="1.1"></td>
                            <td><input type="text" class="table-input" value="1.8"></td>
                            <td><input type="text" class="table-input" value="5.2"></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="table-input" value="1.8"></td>
                            <td><input type="text" class="table-input" value="0.9"></td>
                            <td><input type="text" class="table-input" value="0.6"></td>
                            <td><input type="text" class="table-input" value="0.2"></td>
                            <td><input type="text" class="table-input" value="92"></td>
                            <td><input type="text" class="table-input" value="6.5"></td>
                            <td><input type="text" class="table-input" value="0.8"></td>
                            <td><input type="text" class="table-input" value="0.3"></td>
                            <td><input type="text" class="table-input" value="1.2"></td>
                            <td><input type="text" class="table-input" value="0.8"></td>
    ...
    <script>
        ...
        function exporterResultats() {
            showNotification('Export des résultats en cours...', 'info');
        ...
        function imprimerRapport() {
            showNotification('Impression du rapport en cours...', 'info');

<?php 
$pageTitle = "Registre des Sondages";
...
<body>
    <div class="main-container">
        <div class="page-header">
            <h1 class="page-title">
                ...
                Registre des Sondages
            </h1>
            <p class="page-subtitle">
                Historique et suivi des opérations de sondage
            </p>
        </div>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Sondeur A</td>
                            <td>
                                <span class="rapport-badge rapport-disponible" onclick="voirRapport('REF-SOND-2024-001')">
                        ...
                        <tr>
                            ...
                            <td>Sondeur B</td>
                            <td>
                                <span class="rapport-badge rapport-disponible" onclick="voirRapport('REF-SOND-2024-002')">
                                    <i class="fas fa-eye"></i> Voir
                                </span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>Sondeur C</td>
                            <td>
                                <span class="rapport-badge rapport-disponible" onclick="voirRapport('REF-SOND-2024-004')">
                                    <i class="fas fa-eye"></i> Voir
                                </span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>Sondeur A</td>
                            <td>
                                <span class="rapport-badge rapport-disponible" onclick="voirRapport('REF-SOND-2024-005')">
                                    <i class="fas fa-eye"></i> Voir
                                </span>
                            </td>
                        </tr>
    ...
    <script>
            ...
            if (confirm(`Êtes-vous sûr de vouloir sonder ${selectedRows.length} lot(s) sélectionné(s) ?`)) {
                ...
                setTimeout(() => {
                    selectedRows.forEach(checkbox => {
                        ...
                        const dateSondageCell = row.cells[11];
                        const poidsCell = row.cells[12];
                        const sondeurCell = row.cells[13];
                        const rapportCell = row.cells[14];
                        
                        // Mise à jour des données
                        statusCell.className = 'sondage-status status-sonde';
                        statusCell.innerHTML = '<i class="fas fa-check"></i> Sondé';
                        dateSondageCell.textContent = new Date().toLocaleDateString('fr-FR');
                        poidsCell.textContent = (Math.random() * 2 + 1).toFixed(1) + ' kg';
                        sondeurCell.textContent = 'Sondeur ' + String.fromCharCode(65 + Math.floor(Math.random() * 3));
                        rapportCell.innerHTML = '<span class="rapport-badge rapport-disponible" onclick="voirRapport(\'' + row.cells[3].textContent + '\')"><i class="fas fa-eye"></i> Voir</span>';
        ...
        function voirRapport(reference) {
            showNotification(`Ouverture du rapport ${reference}...`, 'info');
            
            // Simulation d'ouverture de rapport
            setTimeout(() => {
                showNotification(`Rapport ${reference} ouvert avec succès !`, 'success');
            }, 1000);
        }

        // Fonction pour exporter le registre
        function exporterRegistre() {
            showNotification('Export du registre des sondages en cours...', 'info');
        ...
        function genererRapport() {
            const selectedRows = document.querySelectorAll('.check-input:checked');
            if (selectedRows.length === 0) {
                showNotification('Veuillez sélectionner au moins un lot pour générer le rapport', 'warning');
                return;
            }

<?php 
$pageTitle = "Brassage des Échantillons";
...
<body>
    <div class="main-container">
        <div class="page-header">
            <h1 class="page-title">
                ...
                Brassage des Échantillons
            </h1>
            <p class="page-subtitle">
                Gestion du brassage des échantillons pour analyse
            </p>
        </div>
        ...
        <div class="content-section">
            ...
            <div class="actions-section">
                ...
                <button type="button" class="btn btn-outline" onclick="planifierBrassage()">
    ...
    <script>
        ...
        function exporterResultats() {
            showNotification('Export des résultats de brassage en cours...', 'info');
        ...
        // Fonction pour planifier le brassage
        function planifierBrassage() {
            const selectedRows = document.querySelectorAll('.data-table tbody tr');
            const selectedRowsArray = Array.from(selectedRows).filter(row => {
                const statusCell = row.querySelector('.brassage-status');
                return statusCell && statusCell.classList.contains('status-a-brasser');
            ...
            if (selectedRowsArray.length === 0) {
                showNotification('Aucun lot à planifier trouvé', 'warning');
                return;
            }

            showNotification('Planification du brassage en cours...', 'info');
            
            // Simulation de planification
            setTimeout(() => {
                showNotification('Brassage planifié avec succès !', 'success');
            }, 2000);
        }
